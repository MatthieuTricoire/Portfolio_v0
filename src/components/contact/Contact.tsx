...
const Contact = () => {
  ...
  return (
    <section className="contact section" id="contact">
      ...
      <span className="section__subtitle">Ça me ferait plaisir :)</span>

      <div className="contact__container grid">
        <div className="contact__content">
          <h3 className="contact__title">On discute</h3>

          <div className="contact__info">
            <div className="contact__card">
              {/* <GrContactInfo className="contact__icon" /> */}
              ...
              <a
                href="mailto:matthieutricoire@gmail.com"
            ...
            <div className="contact__card">
              {/* <GrContactInfo className="contact__icon" /> */}
              <FaSlack className="contact__card-icon" />
              <h3 className="contact__card-title">Slack</h3>
              <span className="contact__card-data">
                matthieutricoire@gmail.com
              </span>
        ...
        <div className="contact__content">
          <h3 className="contact__title">Tu me contactes pour ? </h3>
